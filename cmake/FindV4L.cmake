...
#adjusted by Darius Blaszyk 
#	- find correctly V4L1
#	- adjusted named for found V4L version
#	- add variable to distinguish between compatibility headers for V4L1
...
# check first for libv4l1-videodev.h
find_path(V4L1_INCLUDE_DIRS
	NAMES libv4l1-videodev.h
	HINTS _V4L_ROOT_PATHS
	PATH_SUFFIXES include)

if(V4L1_INCLUDE_DIRS)
	set(V4L1_FOUND 1)
	set(V4L1_COMPATIBILITY_HEADER 1)
else()

	# libv4l1-videodev.h not found check for the legacy videodev.h
	# DB: not tested but should work
	find_path(V4L1_INCLUDE_DIRS
		NAMES videodev.h
		HINTS _V4L_ROOT_PATHS
		PATH_SUFFIXES include)
	...
	if(V4L1_INCLUDE_DIRS)
		set(V4L1_FOUND 1)
		set(V4L1_COMPATIBILITY_HEADER 0)
	endif()
endif()
